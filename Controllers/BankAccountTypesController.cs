...
namespace Carreno_Financial_Portal.Controllers
{
    public class BankAccountTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type")] BankAccountType bankAccountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type")] BankAccountType bankAccountType)
        {
            if (ModelState.IsValid)
            {
