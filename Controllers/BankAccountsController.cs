...
namespace Carreno_Financial_Portal.Controllers
{
    public class BankAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,BankAccountTypeId,OwnerId,Created,Name,Amount,StartingBalance,CurrentBalanec,LowBalanceLevel")] BankAccount bankAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,BankAccountTypeId,OwnerId,Created,Name,Amount,StartingBalance,CurrentBalanec,LowBalanceLevel")] BankAccount bankAccount)
        {
            if (ModelState.IsValid)
            {
